class Players
  COLORS = %w[red green blue yellow violet orange].freeze
  REF = %w[r g b y v o].freeze
  ROLES = %w[code_maker code_breaker].freeze
...
class Bot < Players
  ...
  def bot_guess
    @input_slot = @similarities.nil? ? 1234 : @supset.first
  end
